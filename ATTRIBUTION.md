...
At this stage, Tide Glass sends battery-status, single-photo-capture, and Wi-Fi transfer-mode commands. Gallery imports are copies: Tide Glass does not delete media from the glasses. Video, audio, delete, restart, firmware, and device-setting commands remain disabled.
